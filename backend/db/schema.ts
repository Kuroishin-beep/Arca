 ...
 *
 * The UI never sees this shape. `backend/db/queries.ts` projects it down to the
 * flat `Item` in `backend/domain/types.ts`, so the storage model can evolve without
